<script setup lang="ts">
    import SubscribeImg from "../assets/images/subscribe-img.webp"
</script>
...
.subscribe-contents{
    ...
    .content-title{
        @include f-style(40px, 500, var(--dark-color));
        line-height: 49px;
        max-width: 380px;
    }
    .content-description{
...
@media only screen and (max-width: 880px) {
    ...
    .content-title{
        @include f-style(32px, 500, var(--dark-color));
        line-height: 44px;
        max-width: 380px;
    }
    .content-description{
...
@media only screen and (max-width:780px){
    ...
    .content-description{
        @include f-style(16px, 400,rgb(131, 131, 131));
        line-height: 24px;
        max-width: 100%;
    }
    .content-form{
...
@media only screen and (max-width: 480px) {
    ...
    .content-form{
        ...
        height: 44px;
        input{
            @include f-style(16px, 400, var(--dark-color));
        }
        button{
            padding: 14px 22px;
